...
:--- | ---: | ---:
Kernel, DTB, modules and (kernel) firmware | 4.14.12 | [gentoo-b3-kernel-4.14.12.tar.xz](https://github.com/sakaki-/gentoo-b3-kernel/releases/download/4.14.12/gentoo-b3-kernel-4.14.12.tar.xz)
...
```console
b3 ~ # emaint sync --repo gentoo-b3
b3 ~ # emerge -av =gentoo-b3-kernel-bin-4.14.12
b3 ~ # reboot
```
...
```console
b3 ~ # wget -c https://github.com/sakaki-/gentoo-b3-kernel/releases/download/4.14.12/gentoo-b3-kernel-4.14.12.tar.xz
b3 ~ # tar -xJf gentoo-b3-kernel-4.14.12.tar.xz -C /
b3 ~ # sync && reboot
```
