...
:--- | ---: | ---:
Kernel, DTB, modules and (kernel) firmware | 5.10.3 | [gentoo-b3-kernel-5.10.3.tar.xz](https://github.com/sakaki-/gentoo-b3-kernel/releases/download/5.10.3/gentoo-b3-kernel-5.10.3.tar.xz)
